...
public class viewRouteMemberController {

	@FXML
    private Button backToMainMenu13;

    @FXML
    void backToMainMenuButton13(ActionEvent event) throws IOException {

    	Main m = new Main();
    	m.NextScene("MemberMenu.fxml");
    }
